...
class KnowledgeDistillationVLM(L.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        total_student_loss = student_loss + kd_loss_student * self.kd_weight_student 

        optimizer_teacher, optimizer_student = self.optimizers()
    ...
    def configure_optimizers(self):
        ...
        return [opt_teacher, opt_student]
...
trainer.fit(model_module) #52GB GPU