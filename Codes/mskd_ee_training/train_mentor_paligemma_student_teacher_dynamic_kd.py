...
class KnowledgeDistillationVLM(L.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        total_student_loss = student_loss + kd_loss_student * self.kd_weight_student + 0.5 * kd_loss_mentor * self.kd_weight_mentor  # Student learns from mentor
...
trainer.fit(model_module) #71 GB GPU 